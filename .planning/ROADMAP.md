...
- [ ] **Phase 1: Foundation** - Project scaffolding, database schema, Supabase setup
- [ ] **Phase 2: Authentication** - User signup, login, logout with Supabase Auth
- [ ] **Phase 3: Navigation & UI Shell** - Sidebar, routing, dark theme, RTL support
- [ ] **Phase 4: Document Upload** - File upload infrastructure with batch support
- [ ] **Phase 5: Bank Statement Import** - Bank xlsx/csv parsing and transaction list
- [ ] **Phase 6: Credit Card Import & Linking** - CC statements and linking to bank charges
...
| 3. Navigation & UI Shell | 0/TBD | Not started | - |
| 4. Document Upload | 0/TBD | Not started | - |
| 5. Bank Statement Import | 0/TBD | Not started | - |
| 6. Credit Card Import & Linking | 0/TBD | Not started | - |
